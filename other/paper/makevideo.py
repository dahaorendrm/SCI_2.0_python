...
def matvideo(name = '4D_color_checker', nfiles = 4, nframe = 24):
    ...
    for idx in range(nfiles):
        ...
        img =  tif.imread('/lustre/arce/X_MA/SCI_2.0_python/resultpaper/exp/S3/result/'+name+f'{idx:04d}'+'.tiff.tiff')
        rgb = specimg2rgb(img)
        scio.savemat('./resultpaper/exp/mat/'+name+f'{idx:04d}'+'.mat',{'mea':mea,'rgb':rawrergb,'led':led,'spec':img,'led_complete':led_complete})

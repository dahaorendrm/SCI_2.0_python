...
class DAIN_flow(torch.nn.Module):
    ...
    def forward(self, input):
        ...
        logger.debug('cur_offset_input shape is '+ str(cur_offset_input.size()))
        ...
        if 'debug_info' in locals():
            ...
            debug_info['depth'] = depth_inv
            debug_info['flow_f'] = cur_offset_outputs[0]
            debug_info['flow_inv'] = cur_offset_outputs[1]
            debug_info['context_f'] = cur_ctx_output[0]
            debug_info['context_inv'] = cur_ctx_output[1]
            debug_info['kernel_f'] = cur_filter_output[0]
            debug_info['kernel_inv'] = cur_filter_output[1]
        ...
        if 'debug_info' in locals():
            debug_info['wrappedflow_f'] = cur_offset_outputs[0]
            debug_info['wrappedflow_inv'] = cur_offset_outputs[1]
        # '''
        ...
        if 'debug_info' in locals():
            debug_info['wrapped_ims_f'] = ref0
            debug_info['wrapped_ims_inv'] = ref2
